                ...
                <ul class="list-unstyled">
                    ...
                    <li>
                        <div class="custom-control custom-radio">
                            ...
                            <label class="custom-control-label" for="mobile_money">MTN Mobile Money</label>
                        </div>
                    </li>
                    <li>
                        <div class="custom-control custom-radio">
                            <input type="radio" id="orange_money" name="payment_method" value="orange_money" class="custom-control-input">
