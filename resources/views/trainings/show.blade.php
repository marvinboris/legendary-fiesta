        ...
        <div class="modal-dialog" role="document">
            ...
            <div class="modal-body lead">
                ...
                <ul class="list-unstyled">
                    ...
                    <li>
                        <div class="custom-control custom-radio">
                            <input type="radio" id="wecashup" name="payment_method" value="wecashup" class="custom-control-input">
                            <label class="custom-control-label" for="wecashup">For Africa</label>
                        </div>
                    </li>
                </ul>
            </div>
