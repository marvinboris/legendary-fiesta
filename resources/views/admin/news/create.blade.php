...
@section('content')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Ajouter une actualité</li>
        </ol>
    </nav>
    <h2>
    ...
    <p class="text-muted small pb-2 m-0 border-bottom">Vous pouvez ici créer une actualité et l'ajouter à l'application.</p>
    <form action="{{ route('admin.news.store') }}" method="post" class="pt-3">
        @csrf
