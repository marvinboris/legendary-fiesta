            ...
            <div class="container py-5">
                <div class="row">
                    <div class="col-lg-8 text-light pb-3">
                        ...
                        <div class="btn-group">
                            <a href="{{ route('register') }}" class="btn text-uppercase btn-lg btn-light">Inscription</a>
                            <a href="{{ route('login') }}" class="btn text-uppercase btn-lg btn-primary">Connexion</a>
                        </div>
                    </div>
                    <div class="col-lg-4">
